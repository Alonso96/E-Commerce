...
public class ProductModelDM implements ProductModel<ProductBean> {
	...
	public Collection<ProductBean> getStorico(String user) throws SQLException{
		...
		PreparedStatement preparedStatement = null;
		Collection<ProductBean> products = new LinkedList<ProductBean>();
		String insertSQL = "select prodotti.prodotto, prodotti.urlImmagine from prodotti,carrello,utenti where carrello.Nickname= ? and carrello.IdProdotto=prodotti.Id;";
